...
\paragraph{Casi di abort}
Una transazione può abortire per:
\begin{itemize}
  \item conflitto di accesso (un altro core legge o scrive nel suo write set);
  \item interruzioni, context switch o page fault;
  \item overflow della L1 o limiti hardware (numero massimo di linee marcate);
  \item mancanza di supporto TSX (assenza del bit CPUID.07H.EBX.RTM).
\end{itemize}
